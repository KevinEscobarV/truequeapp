       <x-app-layout>
        ...
        <header>
            ...
            <div class="container z-10 mx-auto px-6 py-8">
                <div class="h-64 rounded-2xl overflow-hidden">
                    <div class="bg-gray-900 bg-opacity-50 backdrop-blur-md backdrop-filter flex items-center justify-center h-full">
                ...
                <div class="md:flex mt-8 md:-mx-4">
                    <div class="w-full h-64 md:mx-4 rounded-2xl overflow-hidden md:w-1/2">
                        <div class="bg-pink-900 bg-opacity-50 backdrop-blur-md backdrop-filter flex items-center h-full">
                    ...
                    <div class="w-full h-64 mt-8 md:mx-4 rounded-2xl overflow-hidden md:mt-0 md:w-1/2">
                        <div class="bg-pink-900 bg-opacity-50 backdrop-blur-md backdrop-filter flex items-center h-full">
                            <div class="px-10 max-w-xl"> 
                ...
                <div class="h-64 mt-8 rounded-2xl overflow-hidden">
                    <div class="bg-gray-900 bg-opacity-50 backdrop-blur-md backdrop-filter flex items-center justify-between h-full">
                        <div class="px-10 max-w-xl">
                ...
                <div class="mt-16">
                    <div class="text-center text-5xl font-extrabold leading-none tracking-tight">
                        <span class="bg-clip-text text-transparent bg-gradient-to-r from-blueGray-600 to-teal-600">
                          PRODUCTOS
                        </span>
                      </div>
                    <div class="grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 mt-6">
                        @foreach ($products as $product)
                            <div class="w-full max-w-sm mx-auto rounded-md shadow-md overflow-hidden bg-white">
                                <div class="flex items-end justify-end h-56 w-full bg-cover" style="background-image: url('{{$product->images->first() ? Storage::url($product->images->first()->url) : asset('img/producto.jpg')}}')">
