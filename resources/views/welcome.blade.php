                    ...
                    <div class="w-full h-64 mt-8 md:mx-4 rounded-md overflow-hidden bg-cover bg-center md:mt-0 md:w-1/2" style="background-image: url('img/estufita.jpeg')">
                        <div class="bg-gray-900 bg-opacity-50 flex items-center h-full">
                            <div class="px-10 max-w-xl"> 
                                ...
                                <p class="mt-2 text-white -400">Ser la empresa reconocida como líder en la comercialización de implementos semi-industriales, con el enfoque de obtener continuamente resultados, junto con el compromiso de servir a nuestros consumidores retándonos continuamente, para alcanzar los máximos niveles de calidad en nuestros productos.</p>
                                <button class="flex items-center mt-4 text-white text-sm uppercase font-medium rounded hover:underline focus:outline-none">
                                    <span>Shop Now</span>
                                    <svg class="h-5 w-5 mx-2" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor"><path d="M17 8l4 4m0 0l-4 4m4-4H3"></path></svg>
                                </button>
                ...
                <div class="mt-16">
                    ...
                    <div class="grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 mt-6">
                        <div class="w-full max-w-sm mx-auto rounded-md shadow-md overflow-hidden">
                            <div class="flex items-end justify-end h-56 w-full bg-cover" style="background-image: url('img/fre.jpeg')">
                                <button class="p-4 rounded-full bg-blueGray-600 text-white mx-5 -mb-4 hover:bg-blueGray-500 focus:outline-none focus:bg-blueGray-500">
                            ...
                            <div class="px-5 py-3 bg-white">
                                <h3 class="text-gray-700 uppercase">Freidor</h3>
                                <span class="text-gray-500 mt-2">Estructurado En Acero</span>
                            </div>
                        </div>
                        <div class="w-full max-w-sm mx-auto rounded-md shadow-md overflow-hidden">
                            <div class="flex items-end justify-end h-56 w-full bg-cover" style="background-image: url('img/vitr.jpeg')">
                                <button class="p-4 rounded-full bg-blueGray-600 text-white mx-5 -mb-4 hover:bg-blueGray-500 focus:outline-none focus:bg-blueGray-500">
                                    <svg class="h-12 w-12" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor"><path d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z"></path></svg>
                                </button>
                            </div>
                            <div class="px-5 py-3 bg-white">
                                <h3 class="text-gray-700 uppercase">Vitrina Calefaccion </h3>
                                <span class="text-gray-500 mt-2">Uso de alimentos</span>
                            </div>
                        </div>
                        <div class="w-full max-w-sm mx-auto rounded-md shadow-md overflow-hidden">
                            <div class="flex items-end justify-end h-56 w-full bg-cover" style="background-image: url('img/horno.jpeg')">
                                <button class="p-4 rounded-full bg-blueGray-600 text-white mx-5 -mb-4 hover:bg-blueGray-500 focus:outline-none focus:bg-blueGray-500">
                                    <svg class="h-12 w-12" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor"><path d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z"></path></svg>
                                </button>
                            </div>
                            <div class="px-5 py-3 bg-white">
                                <h3 class="text-gray-700 uppercase">Hornos</h3>
                                <span class="text-gray-500 mt-2">Preparacion De Alimentos</span>
                            </div>
                        </div>
                        <div class="w-full max-w-sm mx-auto rounded-md shadow-md overflow-hidden">
                            <div class="flex items-end justify-end h-56 w-full bg-cover" style="background-image: url('img/Meson.jpeg')">
                                <button class="p-4 rounded-full bg-blueGray-600 text-white mx-5 -mb-4 hover:bg-blueGray-500 focus:outline-none focus:bg-blueGray-500">
                                    <svg class="h-12 w-12" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" stroke="currentColor"><path d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17m0 0a2 2 0 100 4 2 2 0 000-4zm-8 2a2 2 0 11-4 0 2 2 0 014 0z"></path></svg>
                                </button>
                            </div>
                            <div class="px-5 py-3 bg-white">
                                <h3 class="text-gray-700 uppercase">Mesones </h3>
                                <span class="text-gray-500 mt-2">Estructurados En Acero,Tipo Industrial</span>
                            </div>
                        </div>
